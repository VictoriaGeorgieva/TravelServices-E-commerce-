...
public partial class Checkout : System.Web.UI.Page
{
  ...
  private void PopulateControls()
  {
    ...
    totalAmountLabel.Text = String.Format(new System.Globalization.CultureInfo("bg-BG"), "{0:C}", amount);
    ...
    if (!addressOK)
    {
      ...
      {
        InfoLabel.Text =
          "Трябва да предоставите валиден адрес и кредитна карта "
          + "преди да направите поръчката си.";
      }
      else
      {
        InfoLabel.Text =
         "Трябва да предоставите валиден адрес преди да направите "
         + "поръчката си.";
      }
    }
    else if (!cardOK)
    {
      InfoLabel.Text = "Трябва да предоставите валидна кредитна карта преди "
        + "да направите поръчката си.";
    }
    else
    {
      InfoLabel.Text = 
        "Моля потвърдете, че гореописаните детайли "
        + "са верни преди да продължите.";
    }
