...
public partial class AdminOrderDetails : System.Web.UI.Page
{
  ...
  private void PopulateControls(string orderId)
  {
    ...
    totalAmountLabel.Text = String.Format(new System.Globalization.CultureInfo("bg-BG"), "{0:C}", orderInfo.TotalCost);
