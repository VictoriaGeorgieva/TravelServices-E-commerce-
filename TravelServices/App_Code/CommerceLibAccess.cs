...
public class CommerceLibAccess
{
  public static readonly string[] OrderStatuses = 
    {"Поръчката е направена, известяване на клиента", // 0
    "В очакване на потвърждение за финансите",        // 1
    "Известяване на доставчик-проверка на склад",     // 2
    "В очакване на потвърждение от склада",           // 3
    "В очакване на плащането чрез кредитна карта",    // 4
    "Известяване на доставчик-изпращане",             // 5
    "В очакване на потвърждение за изпращане",        // 6
    "Изпращане на финално известие",                  // 7
    "Поръчката е финализирана",                       // 8
    "Поръчката е отказана"};                          // 9
