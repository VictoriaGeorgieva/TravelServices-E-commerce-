...
public static class CatalogAccess
{
  ...
  public static ProductDetails GetProductDetails(string productId)
  {
    ...
    if (table.Rows.Count > 0)
    {
      ...
      details.Days = dr["Days"].ToString();
      details.AvailableFrom = dr["AvailableFrom"].ToString();
      details.AvailableTo = dr["AvailableTo"].ToString();
    }
    // return department details
    return details;
  }
  ...
  public static bool CreateProduct(string categoryId, string name, string description, string price, string Thumbnail, string Image, string PromoDept, string PromoFront, string Days, string From, string To)
  {
    // get a configured DbCommand object
    DbCommand comm = GenericDataAccess.CreateCommand();
    // set the stored procedure name
    ...
    param.Value = int.Parse(Days);
    param.DbType = DbType.Int32;
    comm.Parameters.Add(param);

    //create a new parameter
    param = comm.CreateParameter();
    param.ParameterName = "@AvailableFrom";
    param.Value = From;
    ...
    //create a new parameter
    param = comm.CreateParameter();
    param.ParameterName = "@AvailableTo";
    param.Value = To;
    param.DbType = DbType.Date;
    comm.Parameters.Add(param);
