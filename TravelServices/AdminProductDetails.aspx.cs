...
public partial class AdminProductDetails : System.Web.UI.Page
{
  ...
  protected void removeButton_Click(object sender, EventArgs e)
  {
    ...
    if (categoriesListRemove.SelectedIndex != -1)
    {
      ...
      statusLabel.Text = success ? "Продуктът е премахнат успешно" : "Премахването на продукта е неуспешно";
      // Refresh the page
      PopulateControls();
    }
    else
  ...
  protected void assignButton_Click(object sender, EventArgs e)
  {
    ...
    if (categoriesListAssign.SelectedIndex != -1)
    {
      ...
      // Display status message
      statusLabel.Text = success ? "Продукта е добавен успешно" : "Продукта не е добавен успешно";
      // Refresh the page
      PopulateControls();
    }
    else
  ...
  protected void moveButton_Click(object sender, EventArgs e)
  {
    ...
    if (categoriesListMove.SelectedIndex != -1)
    {
      ...
      if (!success)
        statusLabel.Text = "Продукта не може да бъде преместен в избраната категория";
      else
  ...
  protected void upload1Button_Click(object sender, EventArgs e)
  {
    ...
    if (image1FileUpload.HasFile)
    {
      ...
      {
        statusLabel.Text = "Снимка 1 не е добавена успешно";
      }
    }
  }
  ...
  protected void upload2Button_Click(object sender, EventArgs e)
  {
    ...
    if (image2FileUpload.HasFile)
    {
      ...
      {
          statusLabel.Text = "Снимка 2 не е добавена успешно";
      }
    }
  }
}
